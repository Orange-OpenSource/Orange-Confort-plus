...
class PauseService {
    ...
    constructor() {
        ...
        this.settingsServices = [ {
            ...
            name: "readingMode",
            instanceService: readingModeServiceInstance.setReadingMode.bind(this),
            value: DEFAULT_VALUE
        } ];
    }
...
let readingModeServiceIsInstanciated;
