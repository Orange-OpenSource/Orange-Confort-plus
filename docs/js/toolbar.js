/*
 * orange-confort-plus - version 5.0.0-alpha.7 - 09/10/2024
...
class ModeComponent extends HTMLElement {
    ...
    displaySettings=settings => {
        ...
        settings.forEach((setting => {
            ...
            if (Object.entries(setting)[0][1].isTool && settingElement) {
                settingElement.classList.remove("d-none");
                settingElement.style.order = Object.entries(setting)[0][1].order?.toString();
            }
        }));
    };
