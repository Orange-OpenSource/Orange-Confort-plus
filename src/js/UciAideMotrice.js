...
UciAideMotrice = {
	...
	InitUciAideMotrice: function () {
		return accessibilitytoolbar.make(["div", {
			id: "uci_contenu_onglet_aidemotrice",
			...
			["div", {"class": "padding-left margin-top-lg uci_w50-left"},
				...
				["input", {
					type: "checkbox",
					name: "a11yJumpToContent",
					id: "a11yJumpToContent",
					value: "true",
					checked: accessibilitytoolbar.userPref.get("a11yJumpToContent") === "true" ? "checked" : false
				}],
				...
				["input", {
					type: "checkbox",
					name: "a11yMotorModeRemote",
					id: "a11yMotorModeRemote",
					value: "true",
					checked: accessibilitytoolbar.userPref.get("a11yMotorModeRemote") === "true" ? "checked" : false
				}],
				["label", {
					"for": "a11yMotorModeRemote",
					"class": "margin-top-lg"
				}, accessibilitytoolbar.get('uci_label_telecomande')],
				["div", {id: "uci_motor_mode", "class": "padding-left-align setting-sub-container"},
					...
					["p", {
						id: "a11yDelayBeforeClick0",
						"class": "margin-top"
					}, accessibilitytoolbar.get('uci_legend_delai_clic')],
					["ul", {
						"class": "uci_liste_bton margin-top-sm",
						id: "uci_reponses_DelayBeforeLoop",
						role: "radiogroup",
						"aria-labelledby": "a11yDelayBeforeClick0"
					},
						["li",
							{
			...
			["div", {"class": "margin-top-lg uci_w50-left"},
				["input", {
					type: "checkbox",
					name: "a11yMotorModeLooping",
					id: "a11yMotorModeLooping",
					value: "true",
					checked: accessibilitytoolbar.userPref.get("a11yMotorModeLooping") === "true" ? "checked" : false
				}],
				...
				["div", {"class": "padding-left-align"},
					...
					// menu position
					["p", {
						id: "a11yMenuPositionning",
						"class": "uci_clear margin-top"
					}, accessibilitytoolbar.get('uci_legend_menupos')],
					["ul", {
						"class": "uci_liste_bton margin-top-sm margin-bottom",
						id: "uci_reponses_a11yMenuPositionning",
						role: "radiogroup",
						"aria-labelledby": "a11yMenuPositionning"
					},
						["li",
							{
					...
					// loop speed
					["p", {
						id: "a11yDelayBeforeLoop",
						"class": "uci_clear margin-top"
					}, accessibilitytoolbar.get('uci_legend_time_before_sel')],
					["ul", {
						"class": "uci_liste_bton margin-top-sm margin-bottom",
						id: "uci_reponses_DelayBeforeLoop_auto",
						role: "radiogroup",
						"aria-labelledby": "a11yDelayBeforeLoop"
					},
						["li",
							{
					...
					["p", {
						id: "a11yQuickMode",
						"class": "uci_clear margin-top"
					}, accessibilitytoolbar.get('uci_legend_pasquickmode')],
					["p", {"class": "font-normal margin-top-sm"}, accessibilitytoolbar.get('uci_help_quickmode')],
					["ul", {
						"class": "uci_liste_bton margin-top-sm margin-bottom",
						id: "uci_reponses_a11yQuickMode",
						role: "radiogroup",
						"aria-labelledby": "a11yQuickMode"
					},
						["li",
							{
