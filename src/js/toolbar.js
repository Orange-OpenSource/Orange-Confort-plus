...
function RemoteControlPad() {
	...
	var createRemoteHTML = function () {
		...
		pad.appendChild(accessibilitytoolbar.make(["map", {name: "remotemap"},
			["area", {
				href: "#",
				"class": "dontclick scrollup",
				shape: "rect",
				coords: "0,0," + imgWidth + "," + (imgHeight / 2),
				alt: accessibilitytoolbar.get("remotepad_scrollup")
			}],
			["area", {
				href: "#",
				"class": "dontclick scrolldown",
				shape: "rect",
				coords: "0," + (imgHeight / 2) + "," + (imgHeight / 2) + "," + imgHeight,
				alt: accessibilitytoolbar.get("remotepad_scrolldown")
			}]
		]));
...
accessibilitytoolbar = {
	...
	freezeGif: function (img) {
		...
		if ((typeof img.className === "string" && img.className.indexOf('uci_disable_image') < 0)) {
			...
			var freeze = function () {
				...
				img.parentNode.insertBefore(accessibilitytoolbar.make(["div", ["button", {
					"class": "ucibtn ucibtn-sm ucibtn-secondary",
					onclick: "accessibilitytoolbar.unFreezeGif(this)",
					"aria-controls": img.id + " canv-" + img.id,
					title: accessibilitytoolbar.get('uci_button_enablegif') + " " + img.alt
				}, accessibilitytoolbar.get('uci_button_enablegif')]]), canvas);
			};
	...
	unFreezeGif: function (img) {
		...
		if (img.nodeName === "BUTTON") {
			img.parentNode.parentNode.insertBefore(accessibilitytoolbar.make(["div", ["button", {
				"class": "ucibtn ucibtn-sm ucibtn-secondary",
				onclick: "accessibilitytoolbar.freezeGif(this)",
				"aria-controls": img.id + " canv-" + img.id,
				title: accessibilitytoolbar.get('uci_button_disablegif') + " " + img.alt
			}, accessibilitytoolbar.get('uci_button_disablegif')]]), img.parentNode);
	...
	toolbarCreateButton: function () {
		return accessibilitytoolbar.make(["p", {
			id: "cdu_close",
			style: accessibilitytoolbar.userPref.get('a11yToolbarEnable') == 'on' ? "display:none" : "display:block"
		},
	...
	createObjectBehaviour: function () {
		...
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_help_menu_button'), function (e) {
			UciIhm.uci_toggle_menu('uci_help_menu', e)
		});
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_lang_menu_button'), function (e) {
			UciIhm.uci_toggle_menu('uci_lang_menu', e)
		});
		...
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_FR'), function () {
			return UciIhm.changement_langue('FR');
		});
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_EN'), function () {
			return UciIhm.changement_langue('EN');
		});
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_ES'), function () {
			return UciIhm.changement_langue('ES');
		});
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_PL'), function () {
			return UciIhm.changement_langue('PL');
		});
		...
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_chekbox_dyslexy_font'), function () {
			return UciTypographie.displayFieldset('uci_fieldset_fontfamily');
		});
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_chekbox_casse'), function () {
			return UciTypographie.displayFieldset('uci_fieldset_changecasse');
		});


		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_link_help_fontfamily'), function () {
			return accessibilitytoolbar.toolbarDisplayHelp('uci_typo_help_fontfamily');
		});
		accessibilitytoolbar.uciAttachEvent('blur', 'onblur', document.getElementById('uci_link_help_fontfamily'), function () {
			return accessibilitytoolbar.toolbarHideHelp('uci_typo_help_fontfamily');
		});

		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_link_help_changecase'), function () {
			return accessibilitytoolbar.toolbarDisplayHelp('uci_typo_help_changecase');
		});
		accessibilitytoolbar.uciAttachEvent('blur', 'onblur', document.getElementById('uci_link_help_changecase'), function () {
			return accessibilitytoolbar.toolbarHideHelp('uci_typo_help_changecase');
		});

		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_link_help_jumptocontent'), function () {
			return accessibilitytoolbar.toolbarDisplayHelp('uci_help_jumptocontent');
		});
		accessibilitytoolbar.uciAttachEvent('blur', 'onblur', document.getElementById('uci_link_help_jumptocontent'), function () {
			return accessibilitytoolbar.toolbarHideHelp('uci_help_jumptocontent');
		});

		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_link_help_listmode'), function () {
			return accessibilitytoolbar.toolbarDisplayHelp('uci_help_listmode');
		});
		accessibilitytoolbar.uciAttachEvent('blur', 'onblur', document.getElementById('uci_link_help_listmode'), function () {
			return accessibilitytoolbar.toolbarHideHelp('uci_help_listmode');
		});

		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_link_help_links'), function () {
			return accessibilitytoolbar.toolbarDisplayHelp('uci_help_links');
		});
		accessibilitytoolbar.uciAttachEvent('blur', 'onblur', document.getElementById('uci_link_help_links'), function () {
			return accessibilitytoolbar.toolbarHideHelp('uci_help_links');
		});

		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_link_help_disabletransp'), function () {
			return accessibilitytoolbar.toolbarDisplayHelp('uci_help_disabletransp');
		});
		accessibilitytoolbar.uciAttachEvent('blur', 'onblur', document.getElementById('uci_link_help_disabletransp'), function () {
			return accessibilitytoolbar.toolbarHideHelp('uci_help_disabletransp');
		});

		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_link_help_disablepppictures'), function () {
			return accessibilitytoolbar.toolbarDisplayHelp('uci_help_disablepppictures');
		});
		accessibilitytoolbar.uciAttachEvent('blur', 'onblur', document.getElementById('uci_link_help_disablepppictures'), function () {
			return accessibilitytoolbar.toolbarHideHelp('uci_help_disablepppictures');
		});

		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_link_help_mask'), function () {
			return accessibilitytoolbar.toolbarDisplayHelp('uci_help_mask');
		});
		accessibilitytoolbar.uciAttachEvent('blur', 'onblur', document.getElementById('uci_link_help_mask'), function () {
			return accessibilitytoolbar.toolbarHideHelp('uci_help_mask');
		});

		accessibilitytoolbar.uciAttachEvent('keydown', 'onkeydown', document.getElementById('uci_reponses_couleur_lien_sel'), function (event) {
			UciApparence.uciFermetureOverlay(event, "uci_palette_couleur_lien_selectionne");
		});
		accessibilitytoolbar.uciAttachEvent('keydown', 'onkeydown', document.getElementById('uci_reponses_couleur_lien_notsel'), function (event) {
			UciApparence.uciFermetureOverlay(event, "uci_palette_couleur_lien_notselectionne");
		});
		accessibilitytoolbar.uciAttachEvent('keydown', 'onkeydown', document.getElementById('uci_reponses_couleur_lien_visite'), function (event) {
			UciApparence.uciFermetureOverlay(event, "uci_palette_couleur_lien_visite");
		});
		accessibilitytoolbar.uciAttachEvent('keydown', 'onkeydown', document.getElementById('uci_reponses_couleurpolice'), function (event) {
			UciApparence.uciFermetureOverlay(event, "uci_palette_couleur_texte");
		});
		accessibilitytoolbar.uciAttachEvent('keydown', 'onkeydown', document.getElementById('uci_reponses_couleurbackground'), function (event) {
			UciApparence.uciFermetureOverlay(event, "uci_palette_couleur_background");
		});
		...
		if (accessibilitytoolbar.profileEnabled) {
			...
			accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_profile_menu_button'), function (e) {
				UciIhm.uci_toggle_menu('uci_profile_menu', e)
			});
			if (onOffEnabled) {
	...
	HidePaletColor: function (e) {
		...
		var target = e.target || e.srcElement;
		setTimeout(function () {
			accessibilitytoolbar.HideColorPalettePret(target)
		}, 5);
	},
	...
	show: function (e) {
		...
		if (!document.getElementById("cdu_toolbar")) {
			...
			if (!document.getElementById('uci_cdu_popin')) {
				document.getElementById('accessibilitytoolbarGraphic').appendChild(accessibilitytoolbar.make(["div", {
					id: "uci_cdu_popin",
					"class": "uci_cdu_popin",
					style: "display:none;"
				}]));
   ...
   */
	...
	makePredefinedCouleurSelect: function () {
		...
		if (accessibilitytoolbar.userPref.get("a11yVisualPredefinedSettings") === "personnal") {
			aCouleur = ["select", {
				"class": "ucibtn ucibtn-sm uci_select_color",
				name: "a11yVisualPredefinedSettings",
				id: "uci_reponses_couleurpredefinie",
				"aria-labelledby": "a11yVisualSettings",
			...
			aCouleur = ["select", {
				...
				id: "uci_reponses_couleurpredefinie",
				"aria-labelledby": "a11yVisualSettings",
				style: "color: " + accessibilitytoolbar.predifinedCombinaisons[accessibilitytoolbar.userPref.get("a11yVisualPredefinedSettings")].fontColor + " !important;background-color:" + accessibilitytoolbar.predifinedCombinaisons[accessibilitytoolbar.userPref.get("a11yVisualPredefinedSettings")].backGroundColor + " !important;"
			}];
		}
		...
		chooseCouleur = ["div", {
			"class": "margin-top uci_custom_color",
			id: "uci_custom_color_panel",
			...
			["div", {"class": "cdu_c"},
				...
				["div", {"class": "cdu_left"},
					["button", {
						type: "button",
						id: "aria_label_texte",
						"class": "uci_inline uci_couleur_li uci_color_btn",
						title: accessibilitytoolbar.get('uci_color_txt_texte'),
						style: "background-color: " + accessibilitytoolbar.userPref.get("a11yFontColor") + "!important"
					}],
			...
			["div", {"class": "cdu_c margin-top"},
				...
				["div", {"class": "cdu_left"},
					["button", {
						type: "button",
						id: "uci_aria_label_fond",
						"class": "uci_inline uci_couleur_li uci_color_btn",
						title: accessibilitytoolbar.get('uci_color_txt_background'),
						style: "background-color: " + accessibilitytoolbar.userPref.get("a11yBackgroundColor") + "!important"
					}],
