	...
	* @private
	...
	createButtonProfile: function () {
		if (accessibilitytoolbar.profileEnabled) {
			return ["li", {
				class: "uci_inline uci_menu_bton",
				id: "uci_profile_list",
				...
				["button", {
					...
					"aria-haspopup": "true",
					"aria-expanded": "false",
					id: "uci_profile_menu_button",
					type: "button",
					title: accessibilitytoolbar.get('uci_txt_link_menu_open') + " " + accessibilitytoolbar.get('uci_txt_link_profil')
				}, accessibilitytoolbar.get('uci_txt_link_profil')],
				["div",
	...
	createProfileList: function () {
		...
		for (profil in accessibilitytoolbar.userPref.settings.profiles) {
			...
			returnSavedProfile = ["li", {class: "uci_menu_ouverture_aide uci_menu_space-between" + current},
				["a", {
					...
					href: "#",
					role: "button",
					class: "uci_profil_link",
					"aria-current": ariaCurrent,
					class: "uci_w-100"
				}, profil],
				["a", {
					id: "uci_profile_edit_" + i,
					href: "#",
					role: "button",
					class: "cdu-icon cdu-icon-edit padding-left padding-right",
					title: accessibilitytoolbar.get("uci_profile_rename") + " " + profil
				}],
				["a", {
					id: "uci_profile_trash_" + i,
					href: "#",
					role: "button",
					class: "cdu-icon cdu-icon-trash padding-left padding-right",
					title: accessibilitytoolbar.get("uci_profile_delete") + " " + profil
				}]
			];
		...
		if (accessibilitytoolbar.userPref.settings.current === '0') {
			tableauProfile.push(["li", {class: "uci_menu_ouverture_aide uci_menu_space-between uci_menu_active"},
				["a", {
					...
					"aria-current": "true",
					class: "uci_w-100"
				}, accessibilitytoolbar.get('uci_predefined_none')]
			]);
		} else {
		...
		if (accessibilitytoolbar.userPref.settings.current === '1') {
			tableauProfile.push(["li", {class: "uci_menu_ouverture_aide uci_menu_space-between uci_menu_active"},
				["a", {
					id: "uci_profile_reading",
					href: "#",
					role: "button",
					"aria-current": "true",
					class: "uci_w-100"
				}, accessibilitytoolbar.get('uci_predefined_improve_readability')],
			]);
		} else {
			tableauProfile.push(["li", {class: "uci_menu_ouverture_aide uci_menu_space-between"},
				["a", {
		...
		if (accessibilitytoolbar.userPref.settings.current === '2') {
			tableauProfile.push(["li", {class: "uci_menu_ouverture_aide uci_menu_space-between uci_menu_active"},
				["a", {
					id: "uci_profile_layout",
					href: "#",
					role: "button",
					"aria-current": "true",
					class: "uci_w-100"
				}, accessibilitytoolbar.get('uci_predefined_change_layout')],
			]);
		} else {
			tableauProfile.push(["li", {class: "uci_menu_ouverture_aide uci_menu_space-between"},
				["a", {
		...
		if (accessibilitytoolbar.userPref.settings.current === '3') {
			tableauProfile.push(["li", {class: "uci_menu_ouverture_aide uci_menu_space-between uci_menu_active"},
				["a", {
					...
					"aria-current": "true",
					class: "uci_w-100"
				}, accessibilitytoolbar.get('uci_predefined_motor_help')],
			]);
		} else {
			tableauProfile.push(["li", {class: "uci_menu_ouverture_aide uci_menu_space-between"},
				["a", {
			...
			["div", {class: "save_popin"},
				["form", {name: "uci_form_profil", action: "#", id: "uci_form_profil"},
					["div", {id: "uci_save_header", class: "uci-save-header"},
						["h2", {
							id: "uci_save_title",
							class: "uci-save-title",
							"tabindex": "0"
						}, accessibilitytoolbar.get('save_service')],
					...
					["div", {class: "margin-top margin-left margin-right"},
						["div",
							["label", {
								class: "labelcolor",
								"for": "uci-selectProfile"
							}, accessibilitytoolbar.get('uci_profile_save_label') + " "],
							UciProfile.selectProfile(),
						],
						["div", {id: "uci_profile_name_container", style: displayInput, class: "margin-top"},
							["label", {
								class: "labelcolor",
								"for": "uci_profile_name"
							}, accessibilitytoolbar.get('uci_profile_new_label'),
								["input", {id: "uci_profile_name", type: "texte", class: "uci_form-control"}],
								["div", {
									id: "uci_profile_info_msg",
									class: "uci_profile_info_msg"
								}, accessibilitytoolbar.get('uci_profile_name_format')]],
						],
					],
					["div", {class: "margin-top margin-left margin-right padding-bottom uci-save-buttons"},
						["input", {
							...
							name: "saveCancel",
							"type": "reset",
							class: "ucibtn-info ucibtn ucibtn-sm",
						...
						["input", {
							...
							name: "saveSubmit",
							"type": "submit",
							class: "ucibtn-primary ucibtn ucibtn-sm",
	...
	selectProfile: function () {
		...
		var profil = null;
		var i = 0;
		var tableauSelectProfile = ["select", {
			id: "uci-selectProfile",
			class: "uci_select_profile margin-left",
			onchange: "if(this.value !== ''){document.getElementById('uci_profile_name_container').style.display = 'none';} else {document.getElementById('uci_profile_name_container').style.display = 'block';}"
		}];
				...
				["form", {name: "uci_form_profil", action: "#", id: "uci_form_profil"},
					["div", {id: "uci_save_header", class: "uci-save-header"},
						["h2", {
							...
							class: "uci-save-title",
							"tabindex": "0"
						}, accessibilitytoolbar.get('uci_rename_profile')],
						["button", {id: "uci_discover_close", class: "ucibtn-secondary uci-popin-btn", type: "button"},
							["span", {"aria-hidden": "true", class: "cdu-icon cdu-icon-croix"}],
							["span", {class: "cdu_n"}, accessibilitytoolbar.get('uci_close_guide')],
						]
					...
					["div", {class: "margin-top margin-left margin-right"},
						...
						["label", {
							class: "labelcolor",
							"for": "uci_profile_name"
						}, accessibilitytoolbar.get('uci_profile_rename_label'),
							["input", {id: "uci_profile_name", type: "texte", class: "uci_form-control", value: profilName}],
							["div", {
								id: "uci_profile_info_msg",
								class: "uci_profile_info_msg"
							}, accessibilitytoolbar.get('uci_profile_name_format')]],
					...
					["div", {class: "margin-top margin-left margin-right padding-bottom uci-save-buttons"},
						...
						["input", {
							...
							"type": "submit",
							class: "ucibtn-primary ucibtn ucibtn-sm",
							value: accessibilitytoolbar.get('uci_button_valid_profil')
						}]
					]
				]
			]
	...
	setFocusOut: function () {
		if (!this.isTrashing) {
			...
			this.timerFocusOut = setTimeout(function () {
