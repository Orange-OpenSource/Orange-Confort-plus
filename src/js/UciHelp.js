	...
	* @private
	...
	createLinkGuide: function () {
		if (accessibilitytoolbar.guideEnabled) {
			return ["li",
				["a", {
					id: "uci_menu_ouverture_guide",
					href: "#",
					class: "uci_menu_ouverture_aide",
					title: accessibilitytoolbar.get('uci_menu_guide')
				},
			...
			["div", {id: "uci_main_popin_help", "class": "uci-main-popin-help"},
				["div", {id: "uci_popin_content", "class": "uci-popin-content"},
					["div", {id: "uci_popin_header", "class": "uci-popin-header"},
						["h2", {
							id: "uci_help_title",
							"class": "uci-popin-title",
							"tabindex": "0"
						}, accessibilitytoolbar.get('uci_menu_guide')],
						["button", {
							"class": "ucibtn-secondary uci-popin-btn",
							id: "uci_help_close",
							title: accessibilitytoolbar.get('uci_close_guide'),
							type: "button"
						},
					...
					["div", {id: "uci_popin_body", "class": "uci-popin-body"},
						["ul",
							["li",
								["a", {
									id: "uci_popin_discover",
									href: "#",
									"class": "uci-popin-li",
									title: accessibilitytoolbar.get('uci_tour_discover_service')
								},

									["span", {
										id: "uci_popin_discover_icon",
										"class": "uci-guide-discover uci-icon margin-left margin-right",
										"aria-hidden": "true"
									}],
									["span", {
										id: "uci_popin_discover_text",
										"class": "uci-popin-text"
									}, accessibilitytoolbar.get('uci_tour_discover_service')]
								]
							],
							["li",
								["a", {
									...
									href: "#",
									"class": "uci-popin-li",
									title: accessibilitytoolbar.get('uci_tour_discover_improve_readability')
								},

									["span", {
										id: "uci_popin_read_icon",
										"class": "uci-guide-readability uci-icon margin-left margin-right",
										"aria-hidden": "true"
									}],
									["span", {
										id: "uci_popin_read_text",
										"class": "uci-popin-text"
									}, accessibilitytoolbar.get('uci_tour_discover_improve_readability')]
								]
							],
							["li",
								["a", {
									...
									href: "#",
									"class": "uci-popin-li",
									title: accessibilitytoolbar.get('uci_tour_discover_edit_layout')
								},

									["span", {
										id: "uci_popin_layout_icon",
										"class": "uci-guide-layout uci-icon margin-left margin-right",
										"aria-hidden": "true"
									}],
									["span", {
										id: "uci_popin_layout_text",
										"class": "uci-popin-text"
									}, accessibilitytoolbar.get('uci_tour_discover_edit_layout')]
								]
							],
							["li",
								["a", {
									...
									href: "#",
									"class": "uci-popin-li",
									title: accessibilitytoolbar.get('uci_tour_discover_use_motor_assistance')
								},

									["span", {
										id: "uci_popin_motor_icon",
										"class": "uci-guide-motor uci-icon margin-left margin-right",
										"aria-hidden": "true"
									}],
									["span", {
										id: "uci_popin_motor_text",
										"class": "uci-popin-text"
									}, accessibilitytoolbar.get('uci_tour_discover_use_motor_assistance')]
								]
							]
						],
						["div", {"class": "uci-popin-buttom"},
							["button", {
								...
								name: "uci_popin_exit",
								"type": "button",
								"class": "ucibtn ucibtn-sm ucibtn-secondary uci-popin-button-right"
							}, accessibilitytoolbar.get('uci_exit')]
						]
					]
				]
			])
		...
		return accessibilitytoolbar.make(["div", {id: "uci_discover", "class": "uci-discover", style: "display:none;"},
			["div", {id: "uci_discover_content", "class": "uci-discover-content"},
				["div", {id: "uci_discover_header", "class": "uci-popin-header"},
					["h2", {
						id: "uci_discover_title",
						"class": "uci-popin-title",
						"tabindex": "0"
					}, accessibilitytoolbar.get('uci_tour_discover_service')],
					["button", {
						"class": "ucibtn-secondary uci-popin-btn",
						id: "uci_discover_close",
						title: accessibilitytoolbar.get('uci_close_guide'),
						type: "button"
					},
						["span", {"aria-hidden": "true", "class": "cdu-icon cdu-icon-croix"}],
				...
				["div", {id: "uci_discover_body", "class": "uci-discover-body"},
					["span", {
						id: "uci_discover_body_text",
						"class": "uci-discover-body-text"
					}, accessibilitytoolbar.get('uci_discover_text')],
					["div", {
						id: "uci_discover_body_exemple",
						"class": "uci-discover-body-exemple",
						"aria-hidden": "true"
					}, "Exemples :"],
					["div", {id: "uci_discover_selection", "class": "margin-bottom", "aria-hidden": "true"},
						...
						["label", {
							"for": "uci_discover_none",
							"class": "margin-right"
						}, accessibilitytoolbar.get('uci_tour_discover_default')],
						["input", {type: "radio", name: "example", id: "uci_discover_reading"}],
						["label", {
							"for": "uci_discover_reading",
							"class": "margin-right"
						}, accessibilitytoolbar.get('uci_tour_discover_improve_readability')],
						["input", {type: "radio", name: "example", id: "uci_discover_layout"}],
						["label", {
							"for": "uci_discover_layout",
							"class": "margin-right"
						}, accessibilitytoolbar.get('uci_tour_discover_edit_layout')]
					],
					["iframe", {
						id: "uci_discover_frame",
						"tabindex": "-1",
						title: "demo",
						name: "uci_discover_frame",
						"class": "uci-discover-frame",
						src: hebergementFullPath + "demo_" + accessibilitytoolbar.strings.getLocale().toLowerCase() + ".html"
					}]
				],
				["div", {"class": "uci-popin-buttom"},
					["button", {
						...
						name: "uci_popin_menu",
						"type": "button",
						"class": "uci-popin-button-left ucibtn-secondary ucibtn ucibtn-sm"
					}, accessibilitytoolbar.get('uci_menu')],
					["div", {"class": "uci-buttom-speed"},
						["button", {
							id: "uci_popin_read_btn",
							title: accessibilitytoolbar.get('uci_predefined_improve_readability'),
							name: "uci_popin_menu",
							"type": "button",
							"class": "uci-popin-button-left ucibtn-secondary ucibtn ucibtn-sm uci-button_noborder uci-guide-readability",
							onclick: "UciHelp.show_reading('uci_tour_step_0_reading')"
						}],
						["button", {
							id: "uci_popin_layout_btn",
							title: accessibilitytoolbar.get('uci_predefined_edit_layout'),
							name: "uci_popin_menu",
							"type": "button",
							"class": "uci-popin-button-left ucibtn-secondary ucibtn ucibtn-sm uci-button_noborder uci-guide-layout",
							onclick: "UciHelp.show_reading('uci_tour_step_3_apparence')"
						}],
						["button", {
							id: "uci_popin_motor_btn",
							title: accessibilitytoolbar.get('uci_predefined_use_motor_assistance'),
							name: "uci_popin_menu",
							"type": "button",
							"class": "uci-popin-button-left ucibtn-secondary ucibtn ucibtn-sm uci-button_noborder uci-guide-motor",
							onclick: "UciHelp.show_reading('uci_tour_step_5_aidemotrice')"
						}]
					],
					["button", {
						id: "uci_popin_exit",
						name: "uci_popin_exit",
						"type": "button",
						"class": "uci-popin-button-right ucibtn-secondary ucibtn ucibtn-sm"
					}, accessibilitytoolbar.get('uci_exit')]
				]
			]
		])
	...
	InitUciReading: function (newName) {
		return accessibilitytoolbar.make(["div", {
			id: "uci_reading",
			onkeydown: "UciHelp.navigation_popin(event, 'uci_reading')",
			name: newName
		},
			["div", {id: "triangle"},
				["div", {"class": "triangle"}]
			...
			["div", {id: "uci_reading_content", "class": "uci-popin-content"},
				["div", {id: "uci_reading_header", "class": "uci-popin-header"},
					["h2", {
						id: "uci_reading_title",
						onkeydown: "UciHelp.navigation_popin(event, 'uci_reading_title')",
						class: "uci-popin-title",
						"tabindex": "0"
					}, "Réglages rapides"],
					["button", {
						id: "uci_reading_close",
						onclick: "UciHelp.hide_popin()",
						title: accessibilitytoolbar.get('uci_close_guide'),
						type: "button",
						"class": "ucibtn-secondary uci-popin-btn"
					},
				...
				["div", {"class": "uci-popin-buttom"},
					["button", {
						id: "uci_reading_menu",
						onclick: "UciHelp.show_menu()",
						name: "uci_reading_menu",
						"type": "button",
						"class": "uci-popin-button-left ucibtn ucibtn-sm ucibtn-secondary"
					}, accessibilitytoolbar.get('uci_menu')],
					["button", {
						id: "uci_reading_move_left",
						onclick: "UciHelp.changeText('previous')",
						onkeydown: "UciHelp.navigation_popin(event, 'previous')",
						"aria_hidden": "true",
						title: accessibilitytoolbar.get('uci_previous'),
						name: "uci_reding_move_Left",
						"type": "button",
						"class": "uci-move-left uci-popin-button-left ucibtn ucibtn-sm ucibtn-secondary"
					},
						["span", {"aria-hidden": "true"}, "<"],
						["span", {"class": "cdu_n"}, accessibilitytoolbar.get('uci_previous')]
					],
					["button", {
						id: "uci_reading_move_right",
						onclick: "UciHelp.changeText('next')",
						onkeydown: "UciHelp.navigation_popin(event, 'next')",
						"aria_hidden": "true",
						title: accessibilitytoolbar.get('uci_next'),
						name: "uci_reading_move_right",
						"type": "button",
						"class": "uci-move-right uci-popin-button-right ucibtn ucibtn-sm ucibtn-secondary"
					},
						["span", {"aria-hidden": "true"}, ">"],
					...
					["button", {
						id: "uci_reading_exit",
						onkeydown: "UciHelp.navigation_popin(event, 'uci_reading_exit')",
						onclick: "UciHelp.hide_popin()",
						name: "uci_reading_exit",
						"type": "button",
						"class": "uci-popin-button-right ucibtn ucibtn-sm ucibtn-secondary"
					}, accessibilitytoolbar.get('uci_exit')]
	...
	attachPopinEvents: function () {
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_popin_exit'), function (e) {
			accessibilitytoolbar.stopEvt(e);
			UciHelp.hide_popin()
		});
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_popin_menu'), function (e) {
			accessibilitytoolbar.stopEvt(e);
			UciHelp.show_menu()
		});
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_reading_menu'), function (e) {
			accessibilitytoolbar.stopEvt(e);
			UciHelp.show_menu()
		});
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_popin_button'), function (e) {
			accessibilitytoolbar.stopEvt(e);
			UciHelp.hide_popin()
		});
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_help_close'), function (e) {
			accessibilitytoolbar.stopEvt(e);
			UciHelp.hide_popin()
		});
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_reading_close'), function (e) {
			accessibilitytoolbar.stopEvt(e);
			UciHelp.hide_popin()
		});
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_reading_exit'), function (e) {
			accessibilitytoolbar.stopEvt(e);
			UciHelp.hide_popin()
		});
		...
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_popin_discover'), function (e) {
			accessibilitytoolbar.stopEvt(e);
			UciHelp.show_discover()
		});
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_popin_read'), function (e) {
			accessibilitytoolbar.stopEvt(e);
			UciHelp.show_reading("uci_tour_step_0_reading")
		});
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_popin_layout'), function (e) {
			accessibilitytoolbar.stopEvt(e);
			UciHelp.show_reading("uci_tour_step_3_apparence")
		});
		accessibilitytoolbar.uciAttachEvent('click', 'onclick', document.getElementById('uci_popin_motor'), function (e) {
			accessibilitytoolbar.stopEvt(e);
			UciHelp.show_reading("uci_tour_step_5_aidemotrice")
		});
		...
		accessibilitytoolbar.uciAttachEvent('resize', 'onresize', window, function () {
			UciHelp.calculate_overlay_position();
			UciHelp._unclickMoreSettings();
			UciHelp.position_popin_help()
		});

		accessibilitytoolbar.uciAttachEvent('keydown', 'onkeydown', document.getElementById('uci_popin_button'), function (event) {
			UciHelp.navigation_popin(event, "uci_popin_button")
		});
		accessibilitytoolbar.uciAttachEvent('keydown', 'onkeydown', document.getElementById('uci_main_popin_help'), function (event) {
			UciHelp.navigation_popin(event, "uci_main_popin_help")
		});
		accessibilitytoolbar.uciAttachEvent('keydown', 'onkeydown', document.getElementById('uci_help_title'), function (event) {
			UciHelp.navigation_popin(event, "uci_help_title")
		});
		...
		accessibilitytoolbar.uciAttachEvent('keydown', 'onkeydown', document.getElementById('uci_popin_exit'), function (event) {
			UciHelp.navigation_popin(event, "uci_popin_exit")
		});
		accessibilitytoolbar.uciAttachEvent('keydown', 'onkeydown', document.getElementById('uci_discover'), function (event) {
			UciHelp.navigation_popin(event, "uci_discover")
		});
		accessibilitytoolbar.uciAttachEvent('keydown', 'onkeydown', document.getElementById('uci_discover_title'), function (event) {
			UciHelp.navigation_popin(event, "uci_discover_title")
		});
	},
