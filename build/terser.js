...
const files = {
	'toolbar': {
		files: [
			...
			'dist/js/app/services/settings/color-read.service.js',
			...
			'dist/js/app/shared/settings/color-read.component.js',
			...
			'dist/js/app/shared/color-profile-rule.component.js',
			...
			'dist/js/app/pages/edit-setting/settings/edit-color-read.component.js',
