...
const files = {
	'toolbar': {
		files: [
			...
			'dist/js/app/services/settings/capitals.service.js',
			...
			'dist/js/app/services/settings/loupe.service.js',
			...
			'dist/js/app/shared/settings/capitals.component.js',
			...
			'dist/js/app/shared/settings/loupe.component.js',
			...
			'dist/js/app/pages/edit-setting/settings/edit-scroll.component.js',
			'dist/js/app/pages/edit-setting/settings/edit-stop-animations.component.js',
