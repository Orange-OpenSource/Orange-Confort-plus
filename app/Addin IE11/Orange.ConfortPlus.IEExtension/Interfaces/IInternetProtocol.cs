// <copyright file="IInternetProtocol.cs" company="Orange SA">
...
namespace Orange.ConfortPlus.IEExtension.Interfaces
{
    ...
    public interface IInternetProtocol
    {
        ...
        [PreserveSig]
        uint Read(IntPtr pv, uint cb, out uint pcbRead);

        void Seek(LARGE_INTEGER dlibMove, uint dwOrigin, out ULARGE_INTEGER plibNewPosition);
