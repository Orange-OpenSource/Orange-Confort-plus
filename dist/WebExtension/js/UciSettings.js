...
UciSettings = {
	...
	InitUciSettings: function () {
		return accessibilitytoolbar.make(["div", {
			id: "uci_contenu_onglet_settings",
			...
			["div", {"class": "uci_onglet_div margin-left margin-right-xlg cdu_c"},
				["div", {id: "uci_div_supprimer_miseenpage"},
					["input", {
						...
						name: "a11yLinearize",
						id: "a11yLinearize",
						checked: accessibilitytoolbar.userPref.get("a11yLinearize") === "true" ? "checked" : false
					}],
				...
				["div", {id: "uci_div_desactiver_transparence"},
					["input", {
						type: "checkbox",
						value: "1",
						name: "a11ySupEffetTransp",
						id: "a11ySupEffetTransp",
						checked: accessibilitytoolbar.userPref.get("a11ySupEffetTransp") === "1" ? "checked" : false
					}],
			...
			["div", {"class": "uci_onglet_div margin-left margin-right-xlg cdu_c"},
				["div", {id: "uci_div_disabled_fond_picture"},
					["input", {
						type: "checkbox",
						value: "true",
						name: "a11ySupImageFont",
						id: "a11ySupImageFont",
						checked: accessibilitytoolbar.userPref.get("a11ySupImageFont") === "true" ? "checked" : false
					}],
				...
				["div", {id: "uci_div_disabled_first_plan_picture"},
					["input", {
						type: "checkbox",
						value: "true",
						name: "a11ySupImageFirstPlan",
						id: "a11ySupImageFirstPlan",
						checked: accessibilitytoolbar.userPref.get("a11ySupImageFirstPlan") === "true" ? "checked" : false
					}],
			...
			["div", {"class": "uci_onglet_div margin-left margin-right cdu_c"},
				["div", {id: "uci_div_disabled_gif"},
					["input", {
						...
						name: "a11ySupGif",
						id: "a11ySupGif",
						checked: accessibilitytoolbar.userPref.get("a11ySupGif") === "true" ? "checked" : false
					}],
				...
				["div", {id: "uci_div_disabled_video"},
					["input", {
						...
						name: "a11yPauseVideo",
						id: "a11yPauseVideo",
						checked: accessibilitytoolbar.userPref.get("a11yPauseVideo") === "true" ? "checked" : false
					}],
