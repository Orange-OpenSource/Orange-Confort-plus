		...
		return accessibilitytoolbar.make(["div", {
			...
			["div", {"class": "margin-left margin-right-xlg margin-top-lg uci_w50-left"},
				["div",
					["input", {
						type: "checkbox",
						value: "true",
						name: "a11yVisualSettings",
						id: "a11yVisualSettings",
			...
			["div", {"class": "margin-left margin-right-xlg margin-top-lg uci_w50-left"},
				["input", {
					type: "checkbox",
					value: "true",
					name: "a11yNavLienEnabled",
					id: "a11yNavLienEnabled",
					checked: accessibilitytoolbar.userPref.get("a11yNavLienEnabled") === "true" ? "checked" : false
				}],
				...
				["div", {id: "uci_gestion_lien"},
					["div", {id: "uci_div_lien_notselectionne"},
						...
						["div", {"class": "cdu_left"},
							["button", {
								type: "button",
								id: "uci_NavLienNonVis",
								"class": "uci_inline uci_couleur_li uci_color_btn",
								title: accessibilitytoolbar.get('uci_title_link_notvisited_color'),
								style: "background-color: " + accessibilitytoolbar.userPref.get("a11yNavLienNonVisColor") + "!important"
							}],
							["div", {
								"class": "uci_span_help_bulle",
								id: "uci_palette_couleur_lien_notselectionne",
								style: "display:none"
							},
					...
					["div", {id: "uci_div_lien_selectionne"},
						...
						["div", {"class": "cdu_left"},
							["button", {
								...
								id: "uci_NavLienSel",
								"class": "uci_inline uci_couleur_li uci_color_btn",
								title: accessibilitytoolbar.get('uci_title_link_active_color'),
								style: "background-color: " + accessibilitytoolbar.userPref.get("a11yNavLienSelColor") + "!important"
							}],
							["div", {
								"class": "uci_span_help_bulle",
					...
					["div", {id: "uci_div_lien_visite"},
						...
						["div", {"class": "cdu_left"},
							["button", {
								...
								id: "uci_NavLienVis",
								"class": "uci_inline uci_couleur_li uci_color_btn",
								title: accessibilitytoolbar.get('uci_title_link_visited_color'),
								style: "background-color: " + accessibilitytoolbar.userPref.get("a11yNavLienVisColor") + "!important"
							}],
			...
			["div", {
				id: "uci_message_constraste",
				style: "display:none;",
				"class": "margin-top margin-bottom message_couleur"
			},
				["div", {style: "color: black !important; background-color: #FFFFFF !important;"}, accessibilitytoolbar.get("uci_color_warning_title")],
				["span", {
					style: "color: black !important; background-color: #FFFFFF !important;",
					"class": "uci_message_contraste_lbl",
					id: "uci_message_contraste_lbl"
				}, accessibilitytoolbar.get('uci_color_warning_content')]
			]
		]);
	}
}
