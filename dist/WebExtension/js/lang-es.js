...
traduction['ES'] = {
	...
	uci_changecase_firstlettre_title: "primera letra de cada palabra en Mayúscula",
	uci_changecase_normal_title: "Mostrar el texto por defecto",
	uci_changecase_tolower: "minúsculas",
	uci_changecase_tolower_title: "texto en minúsculas",
	...
	uci_discover_text: "Este servicio ofrece una veintena de opciones para adaptar la web a sus necesidades: tanto si tiene deficiencias visuales como si simplemente está cansado, ",
	uci_doClick: "Pulsar",
	uci_enableMotorMode: "Asistencia motriz",
	uci_exit: "Salida", // V4
	uci_help_automove: "Selecciona uno tras otro los elementos clicables\nPresiona la tecla Entrar o Espacio para abrir el menú que te permite activar el elemento seleccionado, o bien modificar el tipo de recorrido de la página (rápido, atrás, parar)",
	uci_help_disablepppictures: "Este comando suprime la visualización de imágenes en la página y son reemplazadas por sus alternativas textuales. Un enlace permite visualizar las imágenes a petición ",
	uci_help_disabletransp: "Este comando desactiva los efectos de transparencia eventuales de la página, limitando así las perturbaciones de lectura del contenido",
	uci_help_jumptocontent: "Permite posicionarse automàticamente en el contenido principal de la página, saltandose en particular todos los enlaces de navegación ",
	uci_help_links: "Este comando define la apariencia de los enlaces en la página. Puedes elegir el color y el formato de los enlaces",
	uci_help_listmode: "Este comando reemplaza el tipo de letra del sitio por las tuyas por defecto (aquellas que has definido en tu ordenador o tu navegador). Además el contenido se vuelve completamente lineal y sin columnas.",
	uci_help_quickmode: "(cantidad de elementos «ignorados» entre 2 elementos seleccionados)",
	uci_help_telecomande: "Añade flechas verticales para recorrer la página, activadas al pasar el ratón por encima.\nActiva los elementos clicables al pasar el ratón por encima, y con un retraso predefinido en los ajustes",
	uci_iframe_cookie: "Contenido técnico Orange Confort+",
	uci_label_10par10: "9",
	...
	uci_label_automove: "Navegar con selección automática de elementos",
	uci_label_centeredmenu: "Centrar en la página",
	uci_label_disablebgpictures: "Anula imágenes de fondo",
	uci_label_disablepppictures: "Anula imágenes del primer plano",
	...
	uci_label_listmode: "Desactiva el diseño de la página ",
	uci_mask_label: "Mostrar una máscara de la lectura",
	...
	uci_label_telecomande: "Navegar con clic automático",
	uci_legend_delai_clic: "Temporización del clic automático",
	uci_legend_menupos: "Posición del menú",
	uci_legend_pasquickmode: "Pasos de modo rápido",
	uci_legend_time_before_sel: "Temporización de selección de elementos",
	uci_link_display_picture: "Visualizar la imagen:",
	uci_link_display_picture_no_alt: "Descripción no disponible",
	uci_link_hide_toolbar: "Esconder el panel",
	uci_loopActivable: "Recorrer la página",
	uci_loopActivableQuick: "Navegar rápidamente",
	uci_loopBackward: "Navegar hacia atrás",
	...
	uci_menu_info: "A propósito",
	uci_menu_remove_all: "Reajustar",
	uci_modif_not_saved: "Los ajustes no memorizados se perderán ¿Deseas proseguir esta acción?",
	...
	uci_remove_all_settings: "Se borrarán todos los ajustes ¿Estas seguro de querer proseguir?",
	uci_rename_profile: "Cambiar el nombre del perfil",//V4
	uci_serv_name: "Confort",
	uci_stopLoop: "Parar la navegación",
	...
	uci_titre_links: "Apariencia enlaces de navegación ",
	...
	uci_txt_link_menu_close: "Ocultar menú",
	uci_txt_link_menu_open: "Mostrar menú",
	uci_txt_link_profil: "Perfiles", //V4
	uci_txt_low_settings: "Cerrar el panel más ajustes",
	...
	uci_txt_menu_change_lang_es: "Mostrar el servicio en Español",
	uci_txt_menu_change_lang_fr: "Mostrar el servicio en Francés",
	uci_txt_menu_change_lang_pl: "Mostrar el servicio en Polaco",
	uci_txt_more_settings: "Más ajustes",
	...
	uci_typo_titre_fontsize: "Tamaño del texto",
